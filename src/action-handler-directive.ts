...
customElements.define('action-handler-compound-relative-time', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-compound-relative-time')) {
    return body.querySelector('action-handler-compound-relative-time') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-compound-relative-time');
